<div class="row g-4 text-start">
    <div class="col-md-6">
        ...
        <input type="text" name="name" class="form-control morphism-input @error('name') is-invalid @enderror"
            placeholder="Enter full name" value="{{ old('name', $student->user->name ?? '') }}" required>
        @error('name')
    ...
    <div class="col-md-6">
        ...
        <input type="text" name="father_name"
            class="form-control morphism-input @error('father_name') is-invalid @enderror" placeholder="Fathers Name"
    ...
    <div class="col-md-12">
        ...
        <input type="tel" name="phone" class="form-control morphism-input @error('phone') is-invalid @enderror"
            placeholder="10 digit number" value="{{ old('phone', $student->phone ?? '') }}" required
            pattern="[0-9]{10}">
        @error('phone')
            <div class="invalid-feedback d-block small ms-1">{{ $message }}</div>
        @enderror
