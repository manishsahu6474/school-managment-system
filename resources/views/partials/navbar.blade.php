<nav class="navbar navbar-expand-lg navbar-light bg-primary py-2 px-3 shadow-sm border-bottom border-white-50">
    <div class="container-fluid d-flex align-items-center justify-content-between">
       ...
       <div id="menu-toggle" class="text-white fs-4 d-flex align-items-center justify-content-center me-2" style="cursor: pointer; width: 40px; z-index: 1100;">
    <i class="fas fa-bars"></i> </div>

        <div class="navbar-brand-centered mx-auto">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg mt-2 py-2 animate slideIn" aria-labelledby="profileDrop">
                ...
                <li><a class="dropdown-item py-2 text-danger fw-bold" href="#"><i class="fas fa-sign-out-alt me-2"></i> Logout</a></li>
            </ul>
        </div>
